...
data = {
    ...
    "Gender": "Female",
    "FF_YFF": "10.5%",
    "Interpretation_MDI": "No aneuploidies or microdeletions detected. Fetal fraction is adequate. " * 5,
}
...
def generate_report(options=None, custom_data=None):
    ...
    # Save Output
    output_filename = 'GX_Report_Generated.html'
    ...
    try:
        ...
        pdf_filename = 'GX_Report_Generated.pdf'
